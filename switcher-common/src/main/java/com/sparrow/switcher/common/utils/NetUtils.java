...
public class NetUtils {
    ...
    private static final String CLIENT_LOCAL_IP_PROPERTY = "com.sparrow.client.local.ip";
    
    private static final String CLIENT_LOCAL_PREFER_HOSTNAME_PROPERTY = "com.sparrow.client.local.preferHostname";
