...
public class SparrowRuntimeException extends RuntimeException {
    ...
    public SparrowRuntimeException(int errCode) {
        super();
        this.errCode = errCode;
    }

    public SparrowRuntimeException(int errCode, String errMsg) {
        super(String.format(ERROR_MESSAGE_FORMAT, errCode, errMsg));
        this.errCode = errCode;
    }

    public SparrowRuntimeException(int errCode, Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
    }

    public SparrowRuntimeException(int errCode, String errMsg, Throwable throwable) {
