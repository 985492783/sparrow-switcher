...
import static com.sparrow.switcher.common.remote.exception.SparrowException.SERVER_ERROR;
...
public final class ClassUtils {
    ...
    public static Class findClassByName(String className) {
        try {
            ...
            throw new SparrowRuntimeException(SERVER_ERROR, "this class name not found");
        }
    }
