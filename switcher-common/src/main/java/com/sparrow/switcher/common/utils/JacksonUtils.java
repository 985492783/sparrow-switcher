...
import com.sparrow.switcher.common.remote.exception.runtime.SparrowDeserializationException;
import com.sparrow.switcher.common.remote.exception.runtime.SparrowSerializationException;
...
public final class JacksonUtils {
     ...
     * @param obj obj
     * @return json string
     * @throws SparrowSerializationException if transfer failed
     */
    public static String toJson(Object obj) {
        try {
            return mapper.writeValueAsString(obj);
        } catch (JsonProcessingException e) {
            throw new SparrowSerializationException(obj.getClass(), e);
        }
    }
     ...
     * @return object
     * @throws SparrowDeserializationException if deserialize failed
     */
    public static <T> T toObj(byte[] json, Class<T> cls) {
        try {
            return mapper.readValue(json, cls);
        } catch (Exception e) {
            throw new SparrowDeserializationException(cls, e);
        }
    }
    ...
    public static <T> T toObj(byte[] json, Type cls) {
        try {
            ...
            throw new SparrowDeserializationException(e);
        }
    }
    ...
    public static <T> T toObj(String json, TypeReference<T> typeReference) {
        try {
            ...
            throw new SparrowDeserializationException(typeReference.getClass(), e);
        }
    }
    ...
    public static <T> T toObj(InputStream inputStream, Type type) {
        try {
            ...
            throw new SparrowDeserializationException(type, e);
        }
    }
