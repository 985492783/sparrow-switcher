...
import com.sparrow.switcher.common.remote.RpcScheduledExecutor;
...
import com.sparrow.switcher.common.remote.response.ResponseCode;
...
public class GrpcConnection extends Connection {
    ...
    @Override
    public Response request(Request request, long timeouts) throws SparrowException {
        ...
        try {
            ...
            throw new SparrowException(SparrowException.SERVER_ERROR, e);
        }
    ...
    @Override
    public RequestFuture requestFuture(Request request) throws SparrowException {
        Payload grpcRequest = GrpcUtils.convert(request);
        ...
        return new RequestFuture() {
            ...
            public Response get() throws Exception {
                ...
                if (response instanceof ErrorResponse) {
                    throw new SparrowException(response.getErrorCode(), response.getMessage());
                }
                return response;
            }
    ...
    @Override
    public void asyncRequest(Request request, final RequestCallBack requestCallBack) throws SparrowException {
        Payload grpcRequest = GrpcUtils.convert(request);
        ListenableFuture<Payload> requestFuture = grpcFutureServiceStub.request(grpcRequest);
        ...
        Futures.addCallback(requestFuture, new FutureCallback<Payload>() {
            ...
            public void onSuccess(@Nullable Payload grpcResponse) {
                ...
                if (response != null) {
                    if (response instanceof ErrorResponse) {
                        requestCallBack.onException(new SparrowException(response.getErrorCode(), response.getMessage()));
                    } else {
                        requestCallBack.onResponse(response);
                    }
                } else {
                    requestCallBack.onException(new SparrowException(ResponseCode.FAIL.getCode(), "response is null"));
                }
            }
